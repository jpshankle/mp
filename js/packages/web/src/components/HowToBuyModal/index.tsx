      ...
      cardProps={[
        {
          ...
          imgSrc: `${process.env.ASSET_PREFIX}modals/how-to-buy-1.svg`,
        ...
        },
        {
          ...
          imgSrc: `${process.env.ASSET_PREFIX}modals/how-to-buy-2.svg`,
        ...
        },
        {
          ...
          imgSrc: `${process.env.ASSET_PREFIX}modals/how-to-buy-3.jpg`,
