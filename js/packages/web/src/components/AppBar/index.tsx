...
const MetaplexMenu = () => {
  ...
  if (width < 768)
    return (
      <>
        <Modal
          title={<img src={`${process.env.ASSET_PREFIX}metaplex-logo.svg`} />}
          ...
          closeIcon={
            <img
              ...
              src={`${process.env.ASSET_PREFIX}modals/close.svg`}
            />
          }
        >
...
export const LogoLink = () => {
  return (
    <Link to={`/`}>
      <img src={`${process.env.ASSET_PREFIX}metaplex-logo.svg`} />
    </Link>
  );
};
